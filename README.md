...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; } /* ป้องกันส่วนประกอบล้นจอ */
        ...
        .container { 
            ...
            padding: 20px;
            border-radius: 10px;
            width: 100%; /* บังคับกว้าง 100% ของจอ */
        }
        
        /* Header - ปรับให้รองรับแนวตั้งบนมือถือ */
        .header { 
            display: flex; 
            align-items: center; 
            gap: 15px; 
        ...
        .search-area { 
            margin-bottom: 30px; 
            display: flex; 
            flex-wrap: wrap; /* ให้ปุ่มตัดลงมาได้ถ้าที่แคบ */
            gap: 10px; 
        ...
        /* Boarding Grid - ปรับเป็น 3 คอลัมน์บนมือถือ */
        ...
        .wait-status { text-align: center; color: #f59e0b; width: 100%; display: none; }
        ...
        /* Media Queries สำหรับหน้าจอใหญ่ (Desktop) */
...
<div class="container">
    ...
    <div id="reportArea" style="display:none;">
        ...
        <div class="footer-action">
            <button class="btn-upload" onclick="triggerUpload('dorm')">แนบสลิปจ่ายค่าหอพัก</button>
            <div class="wait-status" id="waitDorm">
                <b>รอตรวจสอบสถานะการจ่าย</b>
                <span>ระบบจะตรวจสอบภายใน 7 วันทำการ</span>
            </div>
        </div>
        ...
        <div class="boarding-box">
            ...
            <div class="total-section">
                <span style="font-size:15px;">ยอดที่ต้องชำระทั้งหมด <br><span style="font-weight:300; color:#777; font-size:12px">( Total Outstanding )</span></span>
                <span id="resTotal" style="color: #333;"></span>
            </div>
        </div>

        <div class="footer-action">
            <button class="btn-upload" onclick="triggerUpload('meal')">แนบสลิปจ่ายค่าอาหาร</button>
    ...
    <div class="bottom-info">
        พบปัญหาโปรดติดต่อ 078 - 789 - 6789<br>
        “ เรียนดี ประพฤติเด่น เน้นคุณภาพ ซึมซาบคุุณธรรม ”
    </div>
</div>

<script>
    // --- สคริปต์ฟังก์ชันเดิมทั้งหมด (คงไว้เพื่อการทำงานที่ถูกต้อง) ---
    ...
    function renderReport(s, prog) {
        ...
        months.forEach((m, i) => {
            ...
            document.getElementById(`a${i+1}`).innerText = (s[amtKeys[i]] || 0).toLocaleString() + " บ.";
        });
    ...
    function handleUpload() {
        ...
        reader.onload = function(e) {
            ...
            .then(() => { Swal.fire('สำเร็จ!', 'แนบสลิปเรียบร้อย ระบบจะตรวจสอบใน 7 วัน', 'success').then(() => location.reload()); })
    ...
    function showPaymentInfo() {
        Swal.fire({
            ...
            html: `<div style="text-align:center;"><p>ธนาคารกรุงไทย<br>เลขบัญชี: 982-x-xxxxx-x<br>โรงเรียนอุทยานศึกษากระบี่</p><img src="https://i.postimg.cc/wBmf1KRW/att-AB9D1Bakym-D8jp-GMVkk-V5n-39QJO5MFVpd7DBp27Jc0.jpg" style="width:100%; max-width:250px; border-radius:10px;"></div>`,
